...
export default function LoginPage({ onLogin, onGoRegister }) {
  const [email, setEmail] = useState('maria.rojas@example.com');
  const [password, setPassword] = useState('123456');
  const [loading, setLoading] = useState(false);

  // Inicia sesión: en la fase mock siembra la sesión desde el perfil del cliente.
      ...
      <div className="nt-auth-card">
        ...
        <form onSubmit={submit}>
          <div className="mb-3">
            ...
            <input type="email" className="form-control form-control-lg" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="tucorreo@example.com" />
          </div>
          <div className="mb-4">
