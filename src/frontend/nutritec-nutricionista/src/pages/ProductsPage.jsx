// Manejar los productos del nutricionista: envío para aprobación y catálogo aprobado.
...
export default function ProductsPage({ userId }) {
  ...
  return (
    <div className="nt-content">
      ...
      <SectionTitle sub="Productos aprobados disponibles para construir planes y para toda la comunidad">Catálogo aprobado</SectionTitle>
